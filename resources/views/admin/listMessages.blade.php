...
<div id="content" class="p-4 p-md-5">
    ...
    <div class="float-sm-right mb-3">
        ...
        <div class="float-sm-right mb-3">
            <a href="{{route('admin.contactPagePersonnel')}}" class="btn btn-primary btn-block btn-register-login">Nouveau message</a>
        </div>
    </div>
                    ...
                    <tbody>
                        @foreach($messagesRecus as $messageRecu)
                            <tr>
                                ...
                                <td><a href="{{route('admin.messages', $messageRecu->id)}}" class="btn btn-primary btn-block btn-register-login">Voir le message</a></td>
