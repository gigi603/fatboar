    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div class="card shadow-lg border-0 rounded-lg mt-5">
        <div class="infos-block">
          ...
          La société FATBOAR, société exerçant dans le secteur de restauration rapide de capital de 750 000 euros, dont le siège social est situé 1Bis Rue Gustave Eiffel, 78280 Guyancourt, immatriculée au registre du commerce et des sociétés de Paris, sous le numéro 781 55516557 organise un jeu avec obligation d’achat d’un menu à partir de 18€ dans tous les restaurants de FATBOAR. Le présent règlement définit les règles juridiques et modalités applicables au Jeu concours.
          ARTICLE 1 – SOCIETE ORGANISATRICE
          La société Fatboar, société anonyme au capital de 750 000 Euros, immatriculée au RCS de Paris sous le numéro 484 969 950, ayant son siège social au 1 bis Rue Gustave Eiffel, 78280 Guyancourt (ci-après, « la Société Organisatrice »), organise du 16 décembre 2019 au 19 décembre 2019, un jeu gratuit avec obligation d’achat (ci-après dénommé le « Jeu »), sur www.fatboar.ovh (ci-après le « Site internet »).

          Les modalités de participation au Jeu et les modalités de désignation des gagnants sont décrites dans le présent règlement (ci-après « le Règlement »). Le Règlement peut être consulté pendant toute la durée du Jeu sur le Site internet, à l’adresse url suivante : https://fatboar.ovh/cgu.
          ...
          Dotation mise en jeu lors du tirage au sort, 100 % des tickets seront gagnants, pour un total de 1 500 000 lots dont la répartition des gains est définie de la façon suivante :

          60% des tickets offrent une entrée ou un dessert au choix soit 900000 tickets.
          ...
          A titre d’information Le véhicule Range Rover Evoque est équipé d’une option roue de secours et carte mains libres, d’une valeur de 59 900 € TTC (selon le tarif applicable au 16 février 2019), consommation mixte (5,4-8,1 L/100km mixte). homologué selon réglementation applicable.

          Les frais d’immatriculation et de mise à la route sont à la charge du gagnant.

          Le gagnant devra répondre à la société organisatrice avant le 30/06/2020 pour confirmer l’acceptation du lot gagné. Tout gagnant qui ne se sera pas manifesté avant cette date sera considéré comme ayant définitivement renoncé à son gain.

          ARTICLE 5 – ATTRIBUTION DES LOTS
          Les Gagnants seront contactés par Fatboar par mail sur l’adresse utilisé par le Gagnant lors de la participation au Jeu, dans un délai de dix (10) jours ouvrés à compter de la fin du Jeu.
