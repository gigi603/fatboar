            ...
            <div class="row justify-content-center">
                <div class="col-sm-9 col-md-7 col-lg-6">
                    <div class="card card-signin my-5">
                      <div class="card-body">
                        <h2 class="card-title title-block text-center">
                        ...
                        <form method="post" action="{{--route('register')--}}">
                          ...
                          <div class="form-group form-check">
                            <input
                              ...
                              id="cguCheck"
                              name="cgu"
                              value="{{ old('cgu') === '1' ? 'checked' : '' }}"
                            />
                            <label class="form-check-label" for="cguCheck">
                                Je confirme avoir pris connaissance et accepter les <a href="#">Conditions G&eacute;n&eacute;rales</a>
                            </label>
                            @error('majeur')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                          ...
                          <div class="form-group form-check">
                            <input
                              ...
                              id="newsCheck"
                              name="majeur"
                              value="{{ old('newsletter') === '1' ? 'checked' : '' }}"
                            />
