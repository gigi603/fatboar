                ...
                <div class="col-sm-4">
					<div class="box text-center">
						...
						<div class="text">
							<span>
                                <p>
                                    Pour r&eacute;cup&eacute;rer votre prix rendez-vous dans n'importe quel restaurant Fatboar avec le num&eacute;ro du ticket.
                                </p>
                                <p>&Aacute; bientôt !</p>
                            </span>
						</div>
						<a href="{{--route('user.gains')--}}">Gains &rarr;</a>
                     </div>
