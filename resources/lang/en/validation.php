    ...
    */
    ...
    'custom' => [
        ...
        'nom' => [
            ...
            'min' => 'Votre nom doit avoir minimum 2 caractères',
            'max' => 'Votre nom ne doit pas dépasser 50 caractères',
            'regex' => 'Votre nom ne doit pas contenir de chiffres ou caractère speciaux',
        ],
        'prenom' => [
            'required' => 'Vous devez saisir votre prenom',
            'min' => 'Votre prénom doit avoir minimum 2 caractères',
            'max' => 'Votre prénom ne doit pas dépasser 50 caractères',
            'regex' => 'Votre prénom ne doit pas contenir de chiffres ou caractère speciaux'
        ],
        'email' => [
            'required' => 'Vous devez saisir votre adresse email',
            'min' => 'Votre email doit contenir minimum 5 caractères',
        ...
        'password' => [
            ...
            'max' => "Votre mot de passe doit contenir pas plus de  50 caractères",
            "confirmed" => "Vous devez confirmer votre mot de passe, soit vous n'avez pas confirmé soit vous n'avez pas tapé le meme mot de passe"
        ],
    ],
